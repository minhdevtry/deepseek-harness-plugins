...
export interface GutterControlsProps {
  editor: Editor
}
...
import { executeAddBlockBelow } from './gutterActions.ts'
export { executeAddBlockBelow }

export function GutterControls({ editor }: GutterControlsProps) {
  ...
  const handleAddBelow = (e: React.MouseEvent) => {
    ...
    executeAddBlockBelow(editor, currentPos, currentNode)
  }
    ...
    <>
      ...
      >
        <div ref={handleRef} className={css.handleButtonGroup}>
          <Tooltip content="Click to add a block below (open slash menu)" placement="top">
            <button
              type="button"
...
export const DragHandleMenu = GutterControls
