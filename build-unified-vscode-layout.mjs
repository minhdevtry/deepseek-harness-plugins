...
// Tab SVG Icon & Middle-Click Close in EditorArea
clientSource = clientSource.replace(
...
clientSource = clientSource.replace('"⋯ 已折叠 " + hiddenCount + " 个隐藏项（点 👁 显示）"', '"⋯ " + hiddenCount + " hidden items collapsed (click 👁 to show)"');
