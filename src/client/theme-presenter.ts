 ...
 *
 * Occupying 'root' means this package replaces the stock frame, and the theme
 * presenter rode along with it — without this the token variables never reach
 * the document and every `--dsw-*` reference in our stylesheets resolves empty.
 * Ported from `.ref/deepseek-harness/packages/client/ui-layout/src/client/theme-presenter.ts`.
 */
